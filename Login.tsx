                ...
                <div className="p-8 md:p-12 flex flex-col justify-center min-h-[600px]">
                        ...
                        <>
                            ...
                            <div className="mb-8 animate-in fade-in slide-in-from-left-4 duration-500">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">CONEXÃO COC PAULÍNIA</p>
                                    </div>
                                </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5 animate-in fade-in duration-700 delay-200">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-3.5 rounded-xl shadow-[0_0_15px_rgba(16,185,129,0.2)] transition-all flex items-center justify-center gap-2 group"
                                >
                                    {loading ? (
                        ...
                        <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            <form onSubmit={handleResetPassword} className="space-y-6">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-bold py-3.5 rounded-xl transition-all shadow-[0_0_15px_rgba(16,185,129,0.2)]"
                                >
                    ...
                    <div className="mt-8 text-center pt-8 border-t border-gray-800/30">
                        <p className="text-xs text-gray-500 uppercase tracking-widest">
                            Plataforma de Gestão — <span className="text-emerald-500 font-bold uppercase tracking-tight">JF EduControl</span>
                        </p>
                    </div>
                </div>

                {/* Right Side - Branding */}
                <div className="hidden md:flex bg-gradient-to-br from-[#0a0f1e] via-[#111827] to-[#0a0f1e] p-12 flex-col items-center justify-center relative overflow-hidden">
                    {/* Decorative Elements */}
                    ...
                    <div className="relative z-10 text-center">
                        ...
                        <h2 className="text-6xl font-black text-emerald-500 mb-6 drop-shadow-md">
                            EduControl
                        </h2>
                        ...
                        <div className="flex items-center justify-center gap-6">
                            <div className="w-14 h-14 bg-[#1a2332] rounded-xl flex items-center justify-center border border-gray-700/50 hover:border-yellow-500/50 transition-all group shadow-lg">
                                <Zap className="w-6 h-6 text-gray-400 group-hover:text-emerald-500" />
                            </div>
                            ...
                            <div className="w-14 h-14 bg-[#1a2332] rounded-xl flex items-center justify-center border border-gray-700/50 hover:border-yellow-500/50 transition-all group shadow-lg">
                                <Rocket className="w-6 h-6 text-gray-400 group-hover:text-emerald-500" />
                            </div>
                        </div>
                    </div>
